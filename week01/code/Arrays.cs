public static class Arrays
{
    ...
    public static double[] MultiplesOf(double number, int length)
    {
        ...
        // 3. Multiply the supplied number by the position + 1.
    ...
    {
        // Plan:
        // 1. Calculate the index where the list should be split using data.Count - amount.
        // 2. Get the elements from the split index to the end of the list.
        // 3. Get the elements from the beginning of the list to the split index.
